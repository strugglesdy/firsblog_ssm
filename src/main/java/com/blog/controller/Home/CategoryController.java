...
public class CategoryController {
    ...
    /**
     * @Title: ArticleListByCategoryView
     * @Description: TODO(根据分类查询文章)
     * @param [model, categoryId]
     * @return java.lang.String
     */
    @RequestMapping("/category/{categoryId}")
    public String ArticleListByCategoryView(Model model,@PathVariable("categoryId") Integer categoryId) throws Exception {
